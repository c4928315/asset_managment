...
import { Name, Email, Tags, Projects, Img, OnotherTags } from "./contactlistCol";
      ...
      },
      {
        ...
        Cell: cellProps => {
          return (
            <>
               <li>
                  <Link to="/contacts-profile"><Projects {...cellProps} /></Link>
                </li>
            </>
          );
        },
  ...
  return (
    <React.Fragment>
      ...
      <div className="page-content" style={{padding: "0", margin: "0"}}>
        <Container fluid>
          {/* Render Breadcrumbs */}
          <Breadcrumbs title="Contacts" breadcrumbItem="Plot Listing" />
          <Row>
            <Col lg="12">
              <Card>
                <CardBody>
